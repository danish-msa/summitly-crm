...
const LoginComponent = () => {
  ...
  const hrefgglePasswordVisibility = (field: PasswordField) => {
  ...
  return (
    <div className="overflow-hidden p-3 acc-vh">
      ...
      <div className="row vh-100 w-100 g-0">
        <div className="col-lg-6 vh-100 overflow-y-auhref overflow-x-hidden">
          {/* start row */}
          <div className="row">
            <div className="col-md-10 mx-auhref">
                ...
                <div>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="input-group input-group-flat pass-group">
                      ...
                      />
                      <span
                        className={`ti hrefggle-password input-group-text hrefggle-password ${
                          passwordVisibility.password ? "ti-eye" : "ti-eye-off"
                        }`}
                        onClick={() => hrefgglePasswordVisibility("password")}
                      ></span>
                    </div>
                  </div>
                  ...
                  <div className="mb-3">
                    <Link
                      href={all_routes.dealsDashboard}
