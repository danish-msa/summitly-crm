...
const MembershipTransactionsComponent = () => {
  ...
  const data = MembershipTransactionsListData;
  const columns = [
    {
      title: "",
      dataIndex: "Name",
      ...
      render: (text: any) => (
        <span
          className={`badge badge-pill badge-status ${
            text === "Completed" ? "bg-success" : "bg-danger"
          }`}
        >
          {text}
        </span>
                    ...
                    <div className="filter-dropdown-menu dropdown-menu dropdown-menu-lg p-0">
                      ...
                      <div className="filter-set-view p-3">
                        ...
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <Link
                            href={all_routes.membershipTransaction}
...
export default MembershipTransactionsComponent;
