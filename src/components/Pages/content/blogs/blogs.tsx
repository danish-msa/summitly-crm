          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center justify-content-between">
                ...
                <Link href={all_routes.addblog} className="btn btn-primary">
              ...
              <div className="card blog-item mb-0">
                <div className="card-body">
                  ...
                  <div className="blog-content">
                    ...
                    <div className="mb-3">
                      <h6 className="mb-2">
                        <Link href={all_routes.blogDetails}>Avoid Setup Mistakes</Link>
                      </h6>
                      <p className="mb-0 truncate-2-lines">
              ...
              <div className="card blog-item mb-0">
                <div className="card-body">
                  ...
                  <div className="blog-content">
                    ...
                    <div className="mb-3">
                      <h6 className="mb-2">
                        <Link href={all_routes.blogDetails}>User Training Tips</Link>
                      </h6>
                      <p className="mb-0 truncate-2-lines">
