...
const BlogCommentsComponent = () => {
  ...
  const data = BlogCommentsListData;
  const columns = [
    {
      title: "Name",
      dataIndex: "Name",
      ...
      render: (text: any) => (
        <span
          className={`badge badge-pill badge-status ${
            text === "Publish" ? "bg-success" : "bg-danger"
          }`}
        >
          {text}
        </span>
        ...
        <div className="dropdown table-action">
          ...
          <div className="dropdown-menu dropdown-menu-right">
            ...
            <Link
              ...
              href="#"
              data-bs-toggle="modal"
              data-bs-target="#delete_comments"
            >
  ...
  return (
    <>
      ...
      <>
        {/* Add New Source */}
        <div className="modal fade" id="add_comment" role="dialog">
        ...
        {/* /Add New Source */}
        {/* Edit Source */}
        <div className="modal fade" id="edit_comments" role="dialog">
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                    ...
                    <div className="d-flex align-items-center">
                      <div className="me-2">
                        <input
                          ...
                          defaultChecked
                        />
                        <label htmlFor="edit-active2">Active</label>
                      </div>
                      <div>
                        <input
                          type="radio"
                          ...
                          name="status"
                        />
                        <label htmlFor="edit-inactive2">Inactive</label>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        {/* /Edit Source */}
        {/* Delete Source */}
        <div className="modal fade" id="delete_comments" role="dialog">
            ...
            <div className="modal-content">
              <div className="modal-body">
                <div className="text-center">
                  ...
                  <p className="mb-0">
                    Are you sure you want to remove blog comment you selected.
                  </p>
                  <div className="d-flex align-items-center justify-content-center mt-4">
                    ...
                    <Link href={all_routes.blogComment} className="btn btn-danger">
                      Yes, Delete it
                    </Link>
                  </div>
                </div>
