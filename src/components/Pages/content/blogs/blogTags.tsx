...
import { blogTagsListData } from "../../../../core/json/blogTagsListData";
import Datatable from "@/core/common/dataTable";
import CommonDatePicker from "@/core/common/common-datePicker/commonDatePicker";
import Link from "next/link";
import { all_routes } from "@/router/all_routes";

const BlogTagsComponent = () => {
  const [searchText, setSearchText] = useState<string>("");
  const handleSearch = (value: string) => {
    setSearchText(value);
  };

  const data = blogTagsListData;
  const columns = [
    {
      title: "Tag Name",
      dataIndex: "Tag_Name",
      sorter: (a: any, b: any) => a.Tag_Name.length - b.Tag_Name.length,
    },
    {
      title: "Created Date",
  ...
  return (
    <>
      ...
      {/* ========================
		...
		========================= */}
      {/* Add New Source */}
      <div className="modal fade" id="add_tags" role="dialog">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Add Blog Tag</h5>
              <button
      ...
      {/* /Add New Source */}
      {/* Edit Source */}
      <div className="modal fade" id="edit_tags" role="dialog">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Edit Blog Tag</h5>
              <button
                className="btn-close custom-btn-close border p-1 me-0 text-dark"
                data-bs-dismiss="modal"
                aria-label="Close"
      ...
      {/* /Edit Source */}
      {/* Delete Source */}
      <div className="modal fade" id="delete_tags" role="dialog">
          ...
          <div className="modal-content">
            <div className="modal-body">
              <div className="text-center">
                ...
                <p className="mb-0">
                  Are you sure you want to remove blog tag you selected.
                </p>
                <div className="d-flex align-items-center justify-content-center mt-4">
                  ...
                  <Link href={all_routes.blogTags} className="btn btn-danger">
                    Yes, Delete it
                  </Link>
                </div>
              </div>
