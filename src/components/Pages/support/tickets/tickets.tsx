...
const TicketsComponent = () => {
  ...
  const columns = [
    ...
    },
    {
      title: "Ticket ID",
      dataIndex: "TicketID",
      render: (text: any) => <Link href={all_routes.ticketsDetails}>{text}</Link>,
    ...
    },
    {
      ...
      render: (text: any, render: any) => (
        <h6 className="d-flex align-items-center fs-14 fw-medium mb-0">
          <Link href="#" className="avatar avatar-xs me-2">
            <ImageWithBasePath
            ...
            <div className="modal-body">
              <div className="text-center">
                ...
                <div className="d-flex align-items-center justify-content-center mt-4">
                  ...
                  <Link href={all_routes.tickets} className="btn btn-danger">
                    Yes, Delete it
                  </Link>
                </div>
              </div>
