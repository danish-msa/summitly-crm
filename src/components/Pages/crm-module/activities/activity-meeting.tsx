...
import { ActivitiesMeetings } from "../../../../core/json/activitiesListData";
import CommonDatePicker from "@/core/common/common-datePicker/commonDatePicker";
import Link from "next/link";
import { all_routes } from "@/router/all_routes";

const ActivityMeetingsComponent = () => {
  const data = ActivitiesMeetings;
  const columns = [
    {
      title: "Titel",
      dataIndex: "Title",
      ...
      <div className="card-body">
        ...
        <div className="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
          <div className="d-flex align-items-center gap-2 flex-wrap">
            ...
            <Link
              href={all_routes.activityMeeting}
...
export default ActivityMeetingsComponent;
