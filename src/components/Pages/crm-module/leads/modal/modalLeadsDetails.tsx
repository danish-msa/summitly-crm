...
import { AccountType, City, Company_Name, Country, Currency, Deals, DocumentType, Industry, Language, Owner, Period, Pipeine, Priority, Source, State, Status_Busy, Status_Open } from "../../../../../core/json/selectOption";
            ...
            <div className="access-wrap">
              <ul>
                <li className="select-people-checkbox">
                  <label className="checkboxs d-flex align-items-center mb-3">
...
export default ModalLeadsDetails