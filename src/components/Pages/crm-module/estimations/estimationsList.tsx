...
const EstimationsListComponent = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text: any, render: any) => (
        <h2 className="d-flex align-items-center">
          ...
          <Link href={all_routes.companiesDetails} className="fs-14 fw-medium">
            {text}
          </Link>
        </h2>
      ),
    ...
    },
    {
      ...
      render: (text: any, render: any) => (
        <h2 className="d-flex align-items-center">
          <Link href="#" className="avatar rounded-circle border me-2">
            <ImageWithBasePath
              className="w-auto h-auto"
              src={`${render.img1}`}
              alt="User Image"
          ...
          <Link href="#" className="fs-14 fw-medium">
            {text}
          </Link>
        </h2>
      ),
    ...
    },
    {
      ...
      render: (text: any, render: any) => (
        <h2 className="d-flex align-items-center">
          ...
          <Link href="#" className="d-flex flex-column fs-14 fw-medium d-flex">
            {text}
            <span className="text-body d-flex mt-1 fs-13 fw-normal">
              {render.posting}{" "}
            </span>
          </Link>
        </h2>
        ...
        <div className="dropdown table-action">
          ...
          <div className="dropdown-menu dropdown-menu-right">
            ...
            <Link className="dropdown-item" href="#">
              <i className="ti ti-checks text-green" /> Mark as Accepted
            </Link>
            <Link className="dropdown-item" href="#">
        ...
        <div className="content pb-0">
          ...
          <div className="card border-0 rounded-0">
            ...
            <div className="card-body">
              ...
              <div className="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                ...
                <div className="d-flex align-items-center gap-2 flex-wrap">
                  ...
                  <div className="d-flex align-items-center shadow p-1 rounded border view-icons bg-white">
                    <Link
                      href={all_routes.estimationList}
                      className="btn btn-sm p-1 border-0 fs-14 active"
                    >
                      <i className="ti ti-list-tree" />
                    </Link>
                    <Link
                      href={all_routes.estimationKanban}
              ...
              {/* table header */}
              {/* Projects List */}
              <div className=" table-nowrap custom-table no-filter">
                <Datatable
                  columns={columns}
                  dataSource={data}
                  Selection={true}
...
export default EstimationsListComponent;
