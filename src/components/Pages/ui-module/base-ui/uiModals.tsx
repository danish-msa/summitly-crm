                      ...
                      <div className="modal-content">
                        <div className="modal-body">
                          <div className="auth-brand text-center mt-2 mb-3 position-relative top-0">
                            <Link href={all_routes.dealsDashboard} className="logo-dark">
                              <span>
                                <ImageWithBasePath 
                            ...
                            <Link href={all_routes.dealsDashboard} className="logo-light">
                              <span>
                                <ImageWithBasePath 
...
export default UiModalsComponents;
