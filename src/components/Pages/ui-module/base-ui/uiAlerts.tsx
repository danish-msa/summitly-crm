...
import CommonUiPageHeader from "@/core/common/commonUiPageHeader/commonUiPageHeader";
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <div className="alert alert-danger" role="alert">
                    <strong>Danger - </strong> A simple danger alert—check it
                    out!
                  </div>
                  <div className="alert alert-warning" role="alert">
                    <strong>Warning - </strong> A simple warning alert—check it
                    out!
                  </div>
          ...
          <div className="row">
            ...
            <div className="col-xl-6">
              <div className="card">
                ...
                <div className="card-body">
                  <p className="text-muted">
                    Display alert with transparent background and with
                    contextual text color. Use classes <code>.bg-white</code>,
                    and
                    <code>.text-*</code>. E.g.{" "}
            ...
            <div className="col-xl-6">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <div
                    className="alert alert-secondary p-3 d-flex"
                    role="alert"
                  >
                  ...
                  <div
                    className="alert alert-primary d-flex p-3 mb-0"
                    role="alert"
                  >
                    <i className="ti ti-mood-smile fs-1 me-2" />
                    <div>
