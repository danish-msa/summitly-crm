                  ...
                  <div className="clipboard">
                    <form className="form-horizontal">
                      ...
                      <button
                        ...
                        onClick={handleCopy}
                      >
                        <i className="ti ti-copy me-1" /> Copy from Input
                      </button>
                      <Link
                        onClick={handleCut}
                      ...
                      >
                        <i className="ti ti-cut me-1" /> Cut from Input
                      </Link>
                    </form>
                  </div>
                </div>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="clipboard copy-txt">
                    ...
                    >
                      <i className="ti ti-copy me-1" /> Copy Link
                    </Link>
                    <Link
                    ...
                    >
                      <i className="ti ti-copy me-1" /> Copy Hidden Code
                    </Link>
                  </div>
                </div>
              </div>
