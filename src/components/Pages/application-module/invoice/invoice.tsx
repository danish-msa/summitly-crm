...
const InvoiceComponent = () => {
  ...
  <div className="page-wrapper">
    ...
    <div className="content content-two">
      {/* Page Header */}
      <PageHeader title="Invoices" moduleTitle="Application" showModuleTile={true} showExport={false} />
                ...
                <table className="table border">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <Link href={all_routes.invoice_details} className="tb-data">
                          INV-1454
                        </Link>
                      </td>
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h6 className="fw-medium mb-1 fs-14">
                              <Link href={all_routes.invoice_details}>Anthony Lewis</Link>
                            </h6>
                      ...
                      <td>
                        <div className="action-icon d-inline-flex">
                          <Link href={all_routes.invoice_details} className="me-2">
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h6 className="fw-medium mb-1 fs-14">
                              <Link href={all_routes.invoice_details}>
                                Brian Villalobos
                              </Link>
                            </h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h6 className="fw-medium mb-1 fs-14">
                              <Link href={all_routes.invoice_details}>Harvey Smith</Link>
                            </h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h6 className="fw-medium mb-1 fs-14">
                              <Link href={all_routes.invoice_details}>Stephan Peralt</Link>
                            </h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h6 className="fw-medium mb-1 fs-14">
                              <Link href={all_routes.invoice_details}>Doglas Martini</Link>
                            </h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h6 className="fw-medium mb-1 fs-14">
                              <Link href={all_routes.invoice_details}>Linda Ray</Link>
                            </h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h6 className="fw-medium mb-1 fs-14">
                              <Link href={all_routes.invoice_details}>Elliot Murray</Link>
                            </h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h6 className="fw-medium mb-1 fs-14">
                              <Link href={all_routes.invoice_details}>Rebecca Smtih</Link>
                            </h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h6 className="fw-medium mb-1 fs-14">
                              <Link href={all_routes.invoice_details}>Connie Waters</Link>
                            </h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h6 className="fw-medium mb-1 fs-14">
                              <Link href={all_routes.invoice_details}>Lori Broaddus</Link>
                            </h6>
