    ...
    <>
      ...
      <div className="page-wrapper">
        ...
        <div className="content pb-0">
          {/* Page Header */}
         <PageHeader title="Notes"moduleTitle="Application" showModuleTile={true}  showExport={false} />

          {/* End Page Header */}
          {/* start row */}
          <div className="row">
            <div className="col-xl-3 col-md-12 theiaStickySidebar ">
              <div className="notes-sidebar-left">
            ...
            {/* end col */}
            <div className="col-xl-9 notes-sidebar-right">
              <div className="card">
                <div className="card-body">
