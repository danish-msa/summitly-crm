              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="bg-light rounded p-2 mb-2">
                    ...
                    <p className="text-dark fw-medium">
                      <Link href="#">Ipad Air (2020) vs Samsung Galaxy Tab</Link>
                    </p>
                  </div>
                  <div className="bg-light rounded p-2 mb-2">
                    <div className="d-flex align-items-center justify-content-between mb-1">
                    ...
                    <p className="text-dark fw-medium">
                      <Link href="#">Beyond capital gains tax! Top 50 stock</Link>
                    </p>
                  </div>
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="d-flex align-items-center flex-wrap gap-1">
                    <Link href="#" className="text-info d-inline-flex link-hover">
                      #HealthTips
                    </Link>
                    <Link href="#" className="text-info d-inline-flex link-hover">
                      #Wellness
