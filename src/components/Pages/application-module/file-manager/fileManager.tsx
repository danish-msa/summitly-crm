            ...
            <div className="col-xl-9">
              ...
              <div className="border-bottom mb-3">
                <div className="d-flex align-items-center justify-content-between mb-2">
                  ...
                  <div>
                    <Link href="#" className="mb-2 fw-medium link-default">
                      View All
                    </Link>
                  </div>
                </div>
      ...
      <>
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h6 className="modal-title mb-0">Create Folder</h6>
                <button
                  type="button"
        ...
        <div className="modal fade" id="add_member">
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h6 className="modal-title">Add Members</h6>
                <button
                  type="button"
                  className="btn-close custom-btn-close"
                  data-bs-dismiss="modal"
            ...
            <div className="p-3">
              ...
              <div className="card shadow-none">
                <div className="card-body p-3 pb-0">
                  <h6 className="mb-3 fs-16">Today</h6>
                  <ul className="recent-activity mb-3">
                    <li className="d-flex pb-2">
                      ...
                      <div className="ms-2 flex-grow-1">
                        <p className="mb-0">
                          <span className="text-dark">Mercy</span> Added New
                    ...
                    <li className="d-flex">
                      ...
                      <div className="ms-2 flex-grow-1">
                        <p className="mb-0">
                          <span className="text-dark">Druman</span> Added New
                          File in <span className="text-dark">ROOT FOLDER</span>
                        </p>
                  ...
                  <h6 className="mb-2 fs-16">28 Jan 2025</h6>
                  <ul className="recent-activity mb-3">
                    <li className="d-flex pb-2">
                      <span className="avatar avatar-md">
                        <ImageWithBasePath
                      ...
                      <div className="ms-2 flex-grow-1">
                        <p className="mb-0">
                          <span className="text-dark">Mercy</span> Added New
                          File in{" "}
                          <span className="text-dark">Personal Assets</span>
                        </p>
                        <p className="mb-0">05:22 PM</p>
                        <div className="bg-light rounded p-2 d-flex align-items-center justify-content-between mt-1">
                          <div className="d-flex align-items-center">
                ...
                <div className="card-body p-3 pb-0">
                  <div className="d-flex align-items-center justify-content-between mb-2">
                    <div className="d-flex align-items-center mb-2">
                      ...
                      <div className="ms-2">
                        <h6 className="fw-medium mb-1 fs-16">Anthony Lewis</h6>
                        <p className="fs-12 mb-0">Finance</p>
                      </div>
                    </div>
                    <Link href="#" className="user-icon mb-2">
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-2">
                    <div className="d-flex align-items-center mb-2">
                      ...
                      <div className="ms-2">
                        <h6 className="fw-medium mb-1 fs-16">Harvey Smith</h6>
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-2">
                    <div className="d-flex align-items-center mb-2">
                      ...
                      <div className="ms-2">
                        <h6 className="fw-medium mb-1 fs-16">Stephan Peralt</h6>
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-2">
                    <div className="d-flex align-items-center mb-2">
                      ...
                      <div className="ms-2">
                        <h6 className="fw-medium mb-1 fs-16">Doglas Martini</h6>
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-2">
                    <div className="d-flex align-items-center mb-2">
                      ...
                      <div className="ms-2">
                        <h6 className="fw-medium mb-1 fs-16">Linda Ray</h6>
                        <p className="fs-12 mb-0">Finance</p>
                      </div>
                    </div>
                    <Link href="#" className="user-icon mb-2">
