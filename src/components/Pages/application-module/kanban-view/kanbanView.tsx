...
const KanbanViewComponent = () => {
    ...
    <>
      ...
      <div className="page-wrapper">
        <div className="content">
          {/* Page Header */}
          <PageHeader title="Kanban View" moduleTitle="Application" showModuleTile={true}  showExport={false} />
  ...
  <div className="dropdown">
    ...
    <ul className="dropdown-menu  dropdown-menu-start">
      <li>
        <Link href="javascript:void(0);" className="dropdown-item rounded-1">
          All
        </Link>
      </li>
      <li>
                                ...
                                {(provided) => (
                                  ...
                                  >
                                    ...
                                    <div className="pt-2">
                                      <Link
                                        href="#"
                                        className="btn btn-secondary border border-dashed d-flex align-items-center justify-content-center"
