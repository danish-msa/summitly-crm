    ...
    },
    {
      ...
      render: (text: string, render: any) => (
        <div className="d-flex align-items-center">
          <Link href="#" className="avatar rounded-circle border p-1 me-2">
            <ImageWithBasePath
          ...
          <Link href="#" className="d-flex flex-column fw-medium">
            {text}
          </Link>
        </div>
      ),
  ...
  return (
    <>
                    ...
                    <div className="filter-dropdown-menu dropdown-menu dropdown-menu-lg p-0">
                      ...
                      <div className="filter-set-view p-3">
                        ...
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <Link
                            href={all_routes.superadminSubscription}
      ...
      {/* ========================
		...
		========================= */}
      {/* Start View Invoice */}
      <div className="modal fade" id="subscribe_detail">
      ...
      {/* End View Invoice */}
      {/* delete modal */}
      <div className="modal fade" id="delete_subscribe">
