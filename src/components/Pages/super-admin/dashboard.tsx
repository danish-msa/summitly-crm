      ...
      <div className="welcome-wrap mb-4">
        <div className=" d-flex align-items-center justify-content-between flex-wrap gap-3 bg-dark rounded p-4">
          ...
          <div className="d-flex align-items-center flex-wrap gap-2">
            <Link href={all_routes.superadminCompany} className="btn btn-danger btn-sm">
              Companies
            </Link>
            <Link href={all_routes.superadminPackagelist} className="btn btn-light btn-sm">
              All Packages
            </Link>
          </div>
        </div>
        ...
        <div className="col-xxl-4 col-xl-12 d-flex">
          <div className="card flex-fill">
            <div className="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
              ...
              <Link
                href={all_routes.superadminPurchaseTransaction}
            ...
            <div className="card-body pb-2">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2 flex-fill">
                    <h6 className="fw-medium text-truncate mb-1 fs-14">
                      <Link href="javscript:void(0);">NovaWave LLC</Link>
                    </h6>
              ...
              <div className="d-sm-flex justify-content-between flex-wrap mb-4">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2 flex-fill">
                    <h6 className="fw-medium text-truncate mb-1 fs-14">
                      <Link href="javscript:void(0);">BlueSky</Link>
                    </h6>
              ...
              <div className="d-sm-flex justify-content-between flex-wrap mb-4">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2 flex-fill">
                    <h6 className="fw-medium text-truncate mb-1 fs-14">
                      <Link href="javscript:void(0);">Silver Hawk</Link>
                    </h6>
              ...
              <div className="d-sm-flex justify-content-between flex-wrap mb-4">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2 flex-fill">
                    <h6 className="fw-medium text-truncate mb-1 fs-14">
                      <Link href="javscript:void(0);">Summit Peak</Link>
                    </h6>
              ...
              <div className="d-sm-flex justify-content-between flex-wrap mb-0">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2 flex-fill">
                    <h6 className="fw-medium text-truncate mb-1 fs-14">
                      <Link href="javscript:void(0);">RiverStone Ltd</Link>
                    </h6>
            ...
            <div className="card-body pb-2">
              ...
              <div className="d-sm-flex justify-content-between flex-wrap mb-4">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2 flex-fill">
                    <h6 className="fw-medium text-truncate mb-1 fs-14">
                      <Link href="javscript:void(0);">Bright Bridge Grp</Link>
                    </h6>
                    <p className="fs-13 mb-0">Basic (Monthly)</p>
                  </div>
                </div>
              ...
              <div className="d-sm-flex justify-content-between flex-wrap mb-4">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2 flex-fill">
                    <h6 className="fw-medium text-truncate mb-1 fs-14">
                      <Link href="javscript:void(0);">CoastalStar Co.</Link>
                    </h6>
              ...
              <div className="d-sm-flex justify-content-between flex-wrap mb-4">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2 flex-fill">
                    <h6 className="fw-medium text-truncate mb-1 fs-14">
                      <Link href="javscript:void(0);">HarborView</Link>
                    </h6>
                    <p className="fs-13 mb-0">Advanced (Monthly)</p>
                  </div>
                </div>
              ...
              <div className="d-sm-flex justify-content-between flex-wrap mb-4">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2 flex-fill">
                    <h6 className="fw-medium text-truncate mb-1 fs-14">
                      <Link href="javscript:void(0);">Golden Gate Ltd</Link>
                    </h6>
                    <p className="fs-13 mb-0">Enterprise (Monthly)</p>
                  </div>
                </div>
              ...
              <div className="d-sm-flex justify-content-between flex-wrap mb-0">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2 flex-fill">
                    <h6 className="fw-medium text-truncate mb-1 fs-14">
                      <Link href="javscript:void(0);">Redwood Inc</Link>
                    </h6>
                    <p className="fs-13 mb-0">Premium (Yearly)</p>
                  </div>
                </div>
            ...
            <div className="card-body pb-2">
              ...
              <div className="d-sm-flex justify-content-between flex-wrap mb-4">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2 flex-fill">
                    <h6 className="fw-medium text-truncate mb-1 fs-14">
                      <Link href="javscript:void(0);">VK Pvt Ltd </Link>
                    </h6>
                    <p className="fs-13 mb-0">14 Sep 2025</p>
                  </div>
                </div>
