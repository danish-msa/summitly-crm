            ...
            <div className="card-body">
               <div className="settings-sidebar">
                ...
                <div className="list-group list-group-flush settings-sidebar">
                  ...
                  <Link href={all_routes.smsGateways} className="d-block p-2 fw-medium">
                    SMS Gateways
                  </Link>
                  <Link href={all_routes.gdprCookies} className="d-block p-2 fw-medium active">
                    GDPR Cookies
                  </Link>
                </div>
              </div>
...
export default GdprCookiesComponent