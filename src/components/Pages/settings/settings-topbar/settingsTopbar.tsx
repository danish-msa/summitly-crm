    ...
    <div className="card border-0">
      <div className="card-body pb-0 pt-0 px-2">
        <ul className="nav nav-tabs nav-bordered nav-bordered-primary">
          ...
          <li className="nav-item me-3">
            <Link
              href={all_routes.invoiceSettings}
              className={`nav-link p-2${
                isActive(all_routes.invoiceSettings) ||
                isActive(all_routes.printers) ||
                isActive(all_routes.customFields)
                  ? " active"
                  : ""
              }`}
            >
          ...
          <li className="nav-item me-3">
            <Link
              href={all_routes.emailSettings}
              className={`nav-link p-2${
                isActive(all_routes.emailSettings) ||
                isActive(all_routes.smsGateways) ||
                isActive(all_routes.gdprCookies)
                  ? " active"
                  : ""
              }`}
            >
          ...
          <li className="nav-item me-3">
            <Link
              ...
              className={`nav-link p-2${
                isActive(all_routes.paymentGateways) ||
                isActive(all_routes.bankAccount) ||
                isActive(all_routes.taxRates) ||
                isActive(all_routes.currencies)
                  ? " active"
                  : ""
              }`}
            >
          ...
          <li className="nav-item">
            <Link
              ...
              className={`nav-link p-2${
                isActive(all_routes.sitemap) ||
                isActive(all_routes.clearCache) ||
                isActive(all_routes.storage) ||
                isActive(all_routes.cronjob) ||
                isActive(all_routes.banIpAddrress) ||
                isActive(all_routes.systemBackup) ||
                isActive(all_routes.databaseBackup) ||
                isActive(all_routes.systemUpdate)
                  ? " active"
                  : ""
              }`}
            >
