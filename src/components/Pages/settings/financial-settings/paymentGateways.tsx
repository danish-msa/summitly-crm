            ...
            <div className="card-body">
              <div className="settings-sidebar">
                ...
                <div className="list-group list-group-flush settings-sidebar">
                  ...
                  <Link
                    href={all_routes.bankAccount}
                    className="d-block p-2 fw-medium"
                  >
                    Bank Accounts
                  </Link>
                  <Link href={all_routes.taxRates} className="d-block p-2 fw-medium">
                    Tax Rates
                  </Link>
                  <Link href={all_routes.currencies} className="d-block p-2 fw-medium">
                    Currencies
                  </Link>
                </div>
              </div>
