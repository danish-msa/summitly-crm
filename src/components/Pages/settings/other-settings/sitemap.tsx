            ...
            <div className="card-body">
              <div className="settings-sidebar">
                ...
                <div className="list-group list-group-flush settings-sidebar">
                  ...
                  <Link href={all_routes.clearCache} className="d-block p-2 fw-medium">
                    Clear Cache{" "}
                  </Link>
                  <Link href={all_routes.storage} className="d-block p-2 fw-medium">
                    Storage
                  </Link>
                  <Link href={all_routes.cronjob} className="d-block p-2 fw-medium">
                    Cronjob
                  </Link>
                  <Link
              ...
              <div className="table-responsive custom-table">
                <table className="table table-nowrap">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <Link href="#">https://localhost/crms</Link>
                      </td>
